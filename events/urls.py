...
from events.frontend_views import (
    ...
    event_edit_view,
    event_list_view,
    transition_delete_view,
)
from events.views import CodeTypeViewSet, EventViewSet
...
urlpatterns = [
    ...
    path("transitions/<int:pk>/delete/", transition_delete_view, name="transition-delete"),
